...
%%
file_name = 'AVG_VELOCITY ANOVA spreadsheet - Oct 05.xlsx';
[num,txt,raw] = xlsread(file_name,1,'C86:F97');
n = 0;
%%
while 1
    rows = [1:7 9:11];
    ...
    save_pdf(hf,mData.pdf_folder,'bar_graph_Oct05',600);
    break;
end
return
%%
...
[xdata,mVar,semVar,combs,p,h,colors,hollowsep] = get_vals_for_bar_graph_RMA(mData,ra,{'Days','hsd'},[1 0.25 1]);
